class Definer {
  //** general errors */
  static general_err1 = "att: somethink went wrong";
  static general_err2 = "att: there is no data with that params!";
  static general_err2 = "att: file upload error!";

  //** member auth releted */
  static auth_err1 = "att: mongoDb validation is failed";
  static auth_err3 = "att: no member width that mb_nick";
  static auth_err4 = "att: your credentials do not match";

  //** products releted errors */
